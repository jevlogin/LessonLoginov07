...
namespace GuessTheNumber
{
    public partial class Form1 : Form
    {
        ...
        private void btnMenuItem1Close_Click(object sender, EventArgs e) => Close();
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            {
                if (tempUserAnswer > CurrentValue) MessageBox.Show($"Ваше значение выше задуманного!");
                else if (tempUserAnswer < CurrentValue) MessageBox.Show($"Ваше значение меньше задуманного!");
